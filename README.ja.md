<div align="center">
  ...
  <h1>Cloud CLI（別名 AI Workspace）</h1>
...
<p align="center">
  <a href="https://cloudcli.ai">CloudCLI Cloud</a> · <a href="https://cloudcli.ai/docs">ドキュメント</a> · <a href="https://discord.gg/buxwujPNRE">Discord</a> · <a href="https://github.com/Clouve/ai-workspace/issues">バグ報告</a> · <a href="CONTRIBUTING.md">コントリビュート</a>
</p>
...
- **[GitHub Issues](https://github.com/Clouve/ai-workspace/issues)** — バグ報告と機能要望
- **[コントリビューションガイド](CONTRIBUTING.md)** — プロジェクトへの貢献方法

## ライセンス

GNU Affero General Public License v3.0 or later (AGPL-3.0-or-later) - 詳細は [LICENSE](LICENSE) ファイルを参照してください（Section 7 の追加条項を含む）。

このプロジェクトはオープンソースであり、AGPL-3.0-or-later ライセンスの下で無料で使用、修正、再配布できます。
...
## スポンサー
- [Clouve - AI を活用したウェブサイトビルダー](https://Clouve.ai)
---
